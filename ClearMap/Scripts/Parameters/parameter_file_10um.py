...
AtlasResolution = (10, 10, 10);

#Path to registration parameters and atlases
PathReg        = '/home/clearmap/Documents/ClearMap_resources';
AtlasFile      = os.path.join(PathReg, '10um_Autofluo_Reference/average_template_10.nrrd');
AnnotationFile = os.path.join(PathReg, 'Regions annotations/annotation_10.nrrd');
...
ResolutionAffineCFosAutoFluo =  (10, 10, 10;

...
baseDirectory = '/home/clearmap/Documents/data/'
...
group1 = ['/home/clearmap/Documents/data/saline/1272/cells_heatmap.tif',
          '/home/clearmap/Documents/data/saline/1273/cells_heatmap.tif',
          '/home/clearmap/Documents/data/saline/1274/cells_heatmap.tif']

group2 = ['/home/clearmap/Documents/data/haloperidol/1267/cells_heatmap.tif',
          '/home/clearmap/Documents/data/haloperidol/1268/cells_heatmap.tif',
          '/home/clearmap/Documents/data/haloperidol/1269/cells_heatmap.tif']
...
io.writeData(os.path.join(baseDirectory, 'group2_mean.raw'), rsp.sagittalToCoronalData(g2a));
io.writeData(os.path.join(baseDirectory, 'group2_std.raw'), rsp.sagittalToCoronalData(g2s));


#Generate the p-values map
##########################
#pcutoff: only display pixels below this level of significance
#AER: cutoffPvalues function defined in tTestVoxelization function in the Statistics.py is lacking an "else", right?
...
io.writeData(os.path.join(baseDirectory, 'pvalues.raw'), rsp.sagittalToCoronalData(pvalsc.astype('float32')));
io.writeData(os.path.join(baseDirectory, 'pvals.raw'), rsp.sagittalToCoronalData(pvals.astype('float32')));
io.writeData(os.path.join(baseDirectory, 'psign.raw'), rsp.sagittalToCoronalData(psign.astype('float32')));
...
############################
#group1 = ['/home/clearmap/Documents/data/saline/1272/cells_transformed_to_Atlas.npy',
#          '/home/clearmap/Documents/data/saline/1273/cells_transformed_to_Atlas.npy',
#          '/home/clearmap/Documents/data/saline/1274/cells_transformed_to_Atlas.npy']
#
#group2 = ['/home/clearmap/Documents/data/haloperidol/1267/cells_transformed_to_Atlas.npy',
#          '/home/clearmap/Documents/data/haloperidol/1268/cells_transformed_to_Atlas.npy',
#          '/home/clearmap/Documents/data/haloperidol/1269/cells_transformed_to_Atlas.npy']
#        
#
...
#
#PathReg        = '/home/clearmap/ClearMap/ClearMap_resources';
#AnnotationFile = os.path.join(PathReg, 'Regions annotations/annotation_25_full.nrrd');
#
